...
export default function QuizPreview() {
  ...
  return (
    <div style={{ maxWidth: "760px", margin: "0 auto", padding: "2rem 1.5rem" }}>
        ...
        <div className="d-flex justify-content-between align-items-center mb-4 py-3 rounded" style={{ background: "#fff",  }}>
            <div>
        ...
        return (
            <div
                ...
                <span className="fw-bold text-secondary ms-3 flex-shrink-0">
